...
public class MessagingTests {
    ...
    void createCompositeProduct1() {
        ...
        Event<Long, Product> expectedEvent =
                new Event<>(CREATE, composite.getProductId(), new Product(composite.getProductId(), composite.getName(), composite.getWeight(), null));

        log.info("productMessage.get(0): {}", productMessages.get(0));
        log.info("is(sameEventExceptionCreatedAt(expectedProductEvent)): {}", is(sameEventExceptCreatedAt(expectedEvent)));
    ...
    void createCompositeProduct2() {
        ...
        Event<Long, Product> expectedProductEvent =
                new Event<>(CREATE, composite.getProductId(), new Product(composite.getProductId(), composite.getName(), composite.getWeight(), null));
        log.info("productMessage.get(0): {}", productMessages.get(0));
        log.info("is(sameEventExceptionCreatedAt(expectedProductEvent)): {}", is(sameEventExceptCreatedAt(expectedProductEvent)));
